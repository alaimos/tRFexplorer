#' Glimma Volcano Plot
#'
#' Draw an interactive Volcano plot
#'
#' @author Shian Su
#'
...
#'
#' @seealso \code{\link{glVolcanoPlot.default}}, \code{\link{glVolcanoPlot.DGELRT}},
#'   \code{\link{glVolcanoPlot.DGEExact}}, \code{\link{glVolcanoPlot.MArrayLM}},
#'   \code{\link{glVolcanoPlot.DESeqDataSet}}
#'
#' @template return_glVolcanoPlot
#'
#' @examples
#' library(limma)
#' library(edgeR)
...
#'
#' \donttest{
#' glVolcanoPlot(vfit, counts=x$counts, anno=x$genes, groups=genotype, samples=1:7,
#'          status=results[,2], main="Volcano plot: Wild-type vs Smchd1",
...
glVolcanoPlot <- function(x, ...) {
    if ("id.column" %in% names(list(...))) stop("argument 'id.column' has been deprecated, please use 'side.main' instead")
    UseMethod("glVolcanoPlot")
}

#' Glimma Volcano Plot
#'
#' Draw an interactive Volcano plot from a data.frame
#'
#' @author Shian Su
#'
#' @inheritParams glVolcanoPlot
...
#' @param ... additional arguments to be passed onto the Volcano plot. (main, xlab,
#'   ylab can be set for the left plot)
#'
#' @template return_glVolcanoPlot
#'
#' @method glVolcanoPlot default
#'
...
glVolcanoPlot.default <- function(
    x,
    xval,
    yval,
    counts = NULL,
...
#' Glimma Volcano Plot
#'
#' Draw an interactive Volcano plot from a DGELRT object
#'
#' @author Shian Su
#'
#' @inheritParams glVolcanoPlot
...
glVolcanoPlot.DGELRT <- function(
    ...
    plotting_data$logOdd <- -log10(plotting_data$Adj.PValue)
    sample_exp <- get_sample_exp(counts, transform, plotting_data, side.main, groups, samples, sample.cols)
...
#' Glimma Volcano Plot
#'
#' Draw an interactive Volcano plot from a DGELRT objet
#'
#' @author Shian Su
#'
#' @inheritParams glVolcanoPlot.DGELRT
#' @param x the DGEExact object.
#'
#' @template return_glVolcanoPlot
#'
#' @method glVolcanoPlot DGEExact
#'
#' @importFrom stats p.adjust
#' @importFrom methods is
#'
...
glVolcanoPlot.DGEExact <- glVolcanoPlot.DGELRT

#' Glimma Volcano Plot
#'
#' Draw an interactive Volcano plot from a MArrayLM object
#'
#' @author Shian Su
#'
#' @inheritParams glVolcanoPlot.DGELRT
...
glVolcanoPlot.MArrayLM <- function(
    x,
    counts = NULL,
    anno = NULL,
    groups = NULL,
...
#' Glimma Volcano Plot
#'
#' Draw an interactive Volcano plot from a DESeqDataSet object
#'
#' @author Shian Su
#'
...
#' @template return_glVolcanoPlot
#'
#' @method glVolcanoPlot DESeqDataSet
#'
#' @importFrom methods is
#' @importFrom edgeR cpm
#'
...
glVolcanoPlot.DESeqDataSet <- function(
    x,
    counts = NULL,
    anno,
    groups,
...
#' Glimma Volcano Plot
#'
#' Draw an interactive Volcano plot from a DESeqResults object
#'
#' @author Shian Su
#'
#' @inheritParams glVolcanoPlot.DESeqDataSet
#' @param x the DESeqResults object.
#'
#' @template return_glVolcanoPlot
#'
#' @method glVolcanoPlot DESeqResults
#'
#' @importFrom methods is
#' @importFrom edgeR cpm
#'
...
glVolcanoPlot.DESeqResults <- function(
    x,
    counts = NULL,
    anno,
    groups,
